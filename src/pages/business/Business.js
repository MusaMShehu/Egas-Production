  ...
  return (
    <div className="business-page">
      ...
      <section className="page-header">
        ...
        <p>Tailored gas supply solutions for restaurants, hotels, and commercial enterprises</p>
      </section>
      ...
      <section className="content-section">
        <div className="two-column">
          ...
          <div className="column-text">
            ...
            <p>Whether you run a restaurant, hotel, manufacturing facility, or any other business that relies on gas, we have the expertise and infrastructure to meet your specific needs with reliable, scalable solutions.</p>
          </div>
        </div>
          ...
          <div className="solutions-accordion">
            {solutions.map((solution, index) => (
              ...
              >
                ...
                >
                  {solution.title}
                  <i className={`fas ${activeSolution === index ? 'fa-chevron-up' : 'fa-chevron-down'}`}></i>
                </div>
