              ...
              {nextDelivery.subscription ? (
                ...
                >
                  ...
                  <div className="subscription-details-content">
                    ...
                    <div className="subscription-info">
                      <span className="subscription-size">
                    ...
                    <div className="subscription-status">
                      Status:{" "}
                      <span
                        className={`status-${nextDelivery.subscription.status}`}
                      >
                        {nextDelivery.subscription.status}
                      </span>
                    </div>
    ...
    <div className="card">
      ...
      <div className="card-content">
        <div className="spending-chart">
          {spendingByMonth.map((item, index) => {
            const percentage =
              maxSpending > 0 ? (item.total / maxSpending) * 100 : 0;
          ...
          <div className="card">
            ...
            <div className="card-content">
              <div className="spending-breakdown">
                ...
                <div className="breakdown-divider"></div>
                <div className="breakdown-total" style={{ cursor: "pointer" }}>
                  <span>Total</span>
                  <span className="total-amount">
                    {formatCurrency(
                      orderMonthly + subscriptionMonthly + topupMonthly,
                    )}
                  </span>
                </div>
              </div>
