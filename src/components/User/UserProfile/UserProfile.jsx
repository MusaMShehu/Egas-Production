...
const Profile = () => {
  const { user: authUser, updateProfile, isLoading: authLoading } = useAuth();
  const [user, setUser] = useState({
    id: "",
    firstName: "",
    lastName: "",
    ...
    state: "",
    gpsCoordinates: { type: "Point", coordinates: [0, 0] },
    profileImage: { url: "", public_id: "", secure_url: "" },
    createdAt: "",
  });
  const [isEditing, setIsEditing] = useState(false);
  const [isLoading, setIsLoading] = useState(true);
  ...
  useEffect(() => {
    if (authUser) {
      setUser({
        ...
        gpsCoordinates: authUser.gpsCoordinates || {
          type: "Point",
          coordinates: [0, 0],
        },
      ...
      if (authUser.profileImage?.secure_url || authUser.profileImage?.url)
        setImagePreview(
          authUser.profileImage.secure_url || authUser.profileImage.url,
        );
      if (authUser.notificationPreferences)
        setNotificationPrefs(authUser.notificationPreferences);
      setIsLoading(false);
    }
  }, [authUser]);
  ...
  const handlePreferenceChange = (e) => {
    ...
    infoToast(
      `${name.split(/(?=[A-Z])/).join(" ")} ${checked ? "enabled" : "disabled"}`,
    );
  };
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      ...
      if (data.success && data.data) {
        const updatedProfileImage = data.data.profileImage || {
          url: data.imageUrl,
          secure_url: data.imageUrl,
        };
        setUser((prev) => ({ ...prev, profileImage: updatedProfileImage }));
        setImagePreview(
          updatedProfileImage.secure_url || updatedProfileImage.url,
        );
        successToast("Profile picture updated successfully!");
  ...
  const handleDeleteImage = async () => {
    if (!user.profileImage?.url && !user.profileImage?.secure_url) {
      warningToast("No profile image to delete.");
      return;
    }
    if (
    ...
    try {
      ...
      const data = response.data;
      if (data.success) {
        const emptyImage = { url: "", public_id: "", secure_url: "" };
        setUser((prev) => ({ ...prev, profileImage: emptyImage }));
        setImagePreview("");
        successToast("Profile picture deleted successfully!");
      } else throw new Error(data.message || "Failed to delete image");
    } catch (error) {
      console.error("Error deleting image:", error);
  ...
  const toggleViewMode = () => {
    setViewMode(!viewMode);
    if (!viewMode) infoToast("View mode enabled. Click Edit to make changes.");
  };
  ...
  const getCurrentLocation = () => {
    ...
    } else warningToast("Geolocation is not supported by this browser.");
  };
  ...
  const getProfilePicUrl = () => {
    if (
      !user.profileImage ||
      (!user.profileImage.url && !user.profileImage.secure_url)
    )
      return "default.jpg";
    const imageUrl = user.profileImage.secure_url || user.profileImage.url;
  ...
  const formatMemberSince = () => {
    ...
    try {
      const date = new Date(dateString);
      if (isNaN(date.getTime())) return "Member since 2023";
    ...
    <div className="prof-profile-page">
        ...
        <div className="prof-header-actions">
          ...
          {!isEditing && !viewMode ? (
            <button
              ...
              disabled={isLoading}
            >
              <FaEdit className="prof-btn-icon" /> Edit Profile
            </button>
          ) : null}
          {isEditing && (
            <div className="prof-edit-actions">
      ...
      <div className="prof-profile-content">
        <div className="prof-profile-card">
          <div className="prof-profile-header">
            <div className="prof-profile-image">
              ...
              <img
                ...
                onClick={
                  viewMode
                    ? () => setImagePreview(getProfilePicUrl())
                    : undefined
                }
                  ...
                  <div className="prof-image-actions">
                    ...
                    {user.profileImage?.url && (
                      <button
                        ...
                        disabled={isLoading}
                      >
                        <FaTrash className="prof-btn-icon" /> Remove
                      </button>
                    )}
                  </div>
                  <div className="prof-upload-hint">
          ...
          <div className="prof-profile-details">
            <h3>
              <FaUser className="prof-section-icon" /> Personal Information
            </h3>
            <div className="prof-detail-grid">
              <div className="prof-detail-item">
                <label>
                  <FaUser className="prof-field-icon" /> First Name
                </label>
                {isEditing && !viewMode ? (
                  <input
                    type="text"
              ...
              <div className="prof-detail-item">
                <label>
                  <FaUser className="prof-field-icon" /> Last Name
                </label>
                {isEditing && !viewMode ? (
                  <input
                    type="text"
              ...
              <div className="prof-detail-item">
                <label>
                  <FaEnvelope className="prof-field-icon" /> Email
                </label>
                {isEditing && !viewMode ? (
                  <input
                    type="email"
              ...
              <div className="prof-detail-item">
                <label>
                  <FaPhone className="prof-field-icon" /> Phone
                </label>
                {isEditing && !viewMode ? (
                  <input
                    type="tel"
              ...
              <div className="prof-detail-item">
                <label>
                  <FaCalendar className="prof-field-icon" /> Date of Birth
                </label>
                {isEditing && !viewMode ? (
                  <input
                    type="date"
              ...
              <div className="prof-detail-item">
                <label>
                  <FaVenusMars className="prof-field-icon" /> Gender
                </label>
                {isEditing && !viewMode ? (
                  <select
                    name="gender"
            ...
            <h3>
              <FaMapMarkedAlt className="prof-section-icon" /> Address
              Information
            </h3>
            <div className="prof-detail-grid">
              <div className="prof-detail-item">
                <label>
                  <FaMapPin className="prof-field-icon" /> Street Address
                </label>
                {isEditing && !viewMode ? (
                  <input
                    type="text"
              ...
              <div className="prof-detail-item">
                <label>
                  <FaMapPin className="prof-field-icon" /> City
                </label>
                {isEditing && !viewMode ? (
                  <input
                    type="text"
              ...
              <div className="prof-detail-item">
                <label>
                  <FaMapPin className="prof-field-icon" /> State
                </label>
                {isEditing && !viewMode ? (
                  <input
                    type="text"
              ...
              <div className="prof-detail-item-full">
                <label>
                  <FaMapMarkerAlt className="prof-field-icon" /> GPS Coordinates
                </label>
                {isEditing && !viewMode ? (
                  <div className="prof-gps-input-container">
                    <input
                    ...
                    <button
                      ...
                      disabled={isLoading}
                    >
                      <FaMapMarkerAlt className="prof-btn-icon" /> Get Current
                      Location
                    </button>
                  </div>
                ) : (
        ...
        <div className="prof-preferences-card">
          <h3>
            <FaBell className="prof-section-icon" /> Notification Preferences
          </h3>
          <div className="prof-preference-item">
            <label className="prof-checkbox-label">
              <input
              ...
              />
              <span className="prof-checkmark"></span>
              <FaShoppingBag className="prof-pref-icon" /> Order Updates
            </label>
          </div>
          <div className="prof-preference-item">
            <label className="prof-checkbox-label">
              ...
              />
              <span className="prof-checkmark"></span>
              <FaTruck className="prof-pref-icon" /> Delivery Notifications
            </label>
          </div>
          <div className="prof-preference-item">
            <label className="prof-checkbox-label">
              ...
              />
              <span className="prof-checkmark"></span>
              <FaTag className="prof-pref-icon" /> Promotional Offers
            </label>
          </div>
          <div className="prof-preference-item">
            <label className="prof-checkbox-label">
              ...
              />
              <span className="prof-checkmark"></span>
              <FaNewspaper className="prof-pref-icon" /> Newsletter
            </label>
          </div>
          {isEditing && !viewMode && (
            <div className="prof-preferences-note">
              <p>
                <FaInfoCircle className="prof-info-icon" /> Notification
                preferences will be saved when you click "Save Changes"
              </p>
            </div>
          )}
          {viewMode && (
            <div className="prof-view-mode-note">
              <p>
                <FaInfoCircle className="prof-info-icon" /> View mode enabled.
