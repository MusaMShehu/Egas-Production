// src/pages/MobileUserSubscriptions.jsx
...
const ConfirmationModal = ({
  ...
  const getButtonStyle = () => {
    switch (type) {
      case "danger":
        return "mobsubs-modal-btn-danger";
      case "info":
        return "mobsubs-modal-btn-info";
      default:
        return "mobsubs-modal-btn-warning";
    }
  };
  return (
    <div className="mobsubs-modal-overlay">
      <div className="mobsubs-modal">
        ...
        <div className="mobsubs-modal-footer">
          ...
          <button
            className={`mobsubs-modal-btn-confirm ${getButtonStyle()}`}
            onClick={onConfirm}
          >
            {confirmText}
          </button>
    ...
    <div className="mobsubs-modal-overlay">
      <div className="mobsubs-modal mobsubs-details-modal">
        ...
        <div className="mobsubs-modal-body">
          ...
          <div className="mobsubs-details-section">
            <h4>
              <FaCalendarCheck /> Subscription Period
            </h4>
            <div className="mobsubs-details-row">
              <span>
                <FaClock /> Start Date:
          ...
          <div className="mobsubs-details-section">
            <h4>
              <FaInfoCircle /> Payment & Status
            </h4>
            <div className="mobsubs-details-row">
              <span>Price:</span>
              <strong className="mobsubs-price">
            ...
            <div className="mobsubs-details-row">
              <span>Status:</span>
              <span
                className={`mobsubs-status-badge ${getStatusClass(subscription.status)}`}
              >
...
const MobileSubscriptions = () => {
  ...
  const fetchSubscriptions = async () => {
    ...
    try {
      ...
      else successToast(`Loaded ${enhancedSubscriptions.length} subscriptions`);
    } catch (err) {
  ...
  const getStatusClass = (status) => {
    switch (status) {
      case "active":
        return "mobsubs-status-active";
      case "paused":
        return "mobsubs-status-paused";
      case "cancelled":
        return "mobsubs-status-cancelled";
      case "expired":
        return "mobsubs-status-expired";
      default:
        return "mobsubs-status-pending";
    }
  };
  const getStatusText = (status) =>
    status?.charAt(0).toUpperCase() + status?.slice(1) || "Pending";
            ...
            setSubscriptions((prev) =>
              prev.map((s) =>
                s._id === subscriptionId
                  ? { ...s, ...data.data, status: "paused" }
                  : s,
              ),
            );
            successToast("Subscription paused successfully");
            fetchSubscriptions();
          } else throw new Error(data.message || "Failed to pause");
        } catch (err) {
      ...
      onConfirm: async () => {
        ...
        try {
          ...
          if (data.success || data.data) {
            ...
            setSubscriptions((prev) =>
              prev.map((s) => (s._id === subscriptionId ? updatedSub : s)),
            );
            successToast("Subscription resumed successfully");
            fetchSubscriptions();
          } else throw new Error(data.message || "Failed to resume");
        } catch (err) {
        ...
        try {
          ...
          if (data.success || data.data) {
            setSubscriptions((prev) =>
              prev.map((s) =>
                s._id === subscriptionId
                  ? { ...s, ...data.data, status: "cancelled" }
                  : s,
              ),
            );
            successToast("Subscription cancelled successfully");
            fetchSubscriptions();
          } else throw new Error(data.message || "Failed to cancel");
        } catch (err) {
    ...
    <div className="mobsubs-mobile-subscriptions">
      ...
      <div className="mobsubs-actions-bar">
        <div className="mobsubs-search-container">
          ...
          {searchQuery && (
            <button
              className="mobsubs-clear-search"
        ...
        <button
          className="mobsubs-new-subscription-btn"
      ...
      {activeSubscriptions.length > 0 && (
        <div className="mobsubs-subscription-section">
          <div className="mobsubs-section-header">
            ...
            <span className="mobsubs-count-badge">
          ...
          <div className="mobsubs-subscriptions-list">
            {activeSubscriptions.map((subscription) => (
              <div
                ...
                className="mobsubs-subscription-card mobsubs-active"
              >
                <div className="mobsubs-subscription-header">
                  <div className="mobsubs-subscription-title">
                    ...
                    <div>
                      ...
                      <p className="mobsubs-subscription-id">
        ...
        <div className="mobsubs-subscription-section">
          ...
          <div className="mobsubs-subscriptions-list">
            {otherSubscriptions.map((subscription) => (
              <div
                key={subscription._id}
                className="mobsubs-subscription-card mobsubs-inactive"
              >
                <div className="mobsubs-subscription-header">
                  <div className="mobsubs-subscription-title">
                    <FaFire className="mobsubs-subscription-icon" />
                ...
                <div className="mobsubs-subscription-details">
                  <div className="mobsubs-detail-row">
                    ...
                    <span className="mobsubs-value">
                      {getStatusText(subscription.status)} since{" "}
