  ...
  return (
    <div className="about-page">
      ...
      <section className="page-hero">
        <h2>About e-GAS</h2>
        <p>Delivering quality gas solutions since 2025</p>
      </section>
      ...
      <section className="about-content">
        <div className="about-container">
          <div className="about-text">
            <h3>Our Story</h3>
            <p>Founded in 2025, e-GAS began with a simple mission: to provide reliable, affordable LPG gas delivery to homes and businesses across Nigeria. What started as a small operation with just two delivery trucks has grown into one of the most trusted names in LPG gas distribution.</p>
            ...
            <p>Today, we serve over 1,000 satisfied customers across Maiduguri, Jere, and part of Konduga, with plans to expand to more cities in the coming year.</p>
          </div>
          
          <div className="about-image">
            <img src="/images/Banner.png" alt="Our Team" />
          </div>
        </div>
      </section>
